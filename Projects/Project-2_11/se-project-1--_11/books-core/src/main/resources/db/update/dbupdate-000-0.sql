...
create cached table T_BOOK ( BOK_ID_C varchar(36) not null, BOK_TITLE_C varchar(255) not null, BOK_SUBTITLE_C varchar(255), BOK_AUTHORS_C varchar(1000) not null,BOK_GENRES_C varchar(500), BOK_DESCRIPTION_C varchar(4000), BOK_ISBN10_C varchar(10), BOK_ISBN13_C varchar(13), BOK_PAGECOUNT_N integer, BOK_LANGUAGE_C varchar(2), BOK_PUBLISHDATE_D datetime,BOK_RATING_N FLOAT,BOK_THUMBNAIL_URL_C varchar(2048), primary key (BOK_ID_C) );
CREATE cached table T_GENRE (GEN_ID_C INT ,GEN_NAME_C VARCHAR(255) NOT NULL,primary key (GEN_ID_C));
CREATE cached table T_BOOK_GENRE (BOK_ID_C VARCHAR(36),GEN_ID_C INT,PRIMARY KEY (BOK_ID_C, GEN_ID_C),FOREIGN KEY (BOK_ID_C) REFERENCES T_BOOK (BOK_ID_C) ON DELETE CASCADE ON UPDATE CASCADE,FOREIGN KEY (GEN_ID_C) REFERENCES T_GENRE (GEN_ID_C) ON DELETE CASCADE ON UPDATE CASCADE);
...
create cached table  T_BOOK_RATING (BR_ID VARCHAR(36) PRIMARY KEY,BOK_ID_C VARCHAR(36) NOT NULL,USR_ID_C VARCHAR(36) NOT NULL,BR_RATING INT NOT NULL,FOREIGN KEY (BOK_ID_C) REFERENCES T_BOOK(BOK_ID_C) ON DELETE CASCADE,FOREIGN KEY (USR_ID_C) REFERENCES T_USER(USE_ID_C) ON DELETE CASCADE);
...
INSERT INTO T_GENRE (GEN_ID_C, GEN_NAME_C) VALUES (1, 'Fiction');
INSERT INTO T_GENRE (GEN_ID_C, GEN_NAME_C) VALUES (2, 'Young Adult (YA)');
INSERT INTO T_GENRE (GEN_ID_C, GEN_NAME_C) VALUES (3, 'Children’s Literature');
INSERT INTO T_GENRE (GEN_ID_C, GEN_NAME_C) VALUES (4, 'Non-Fiction');
INSERT INTO T_GENRE (GEN_ID_C, GEN_NAME_C) VALUES (5, 'History & Culture');
INSERT INTO T_GENRE (GEN_ID_C, GEN_NAME_C) VALUES (6, 'Science & Technology');
INSERT INTO T_GENRE (GEN_ID_C, GEN_NAME_C) VALUES (7, 'Health & Wellness');
INSERT INTO T_GENRE (GEN_ID_C, GEN_NAME_C) VALUES (8, 'Travel & Adventure');
INSERT INTO T_GENRE (GEN_ID_C, GEN_NAME_C) VALUES (9, 'Arts & Crafts');
INSERT INTO T_GENRE (GEN_ID_C, GEN_NAME_C) VALUES (10, 'Mystery & Crime');
